...
const productionIssues: Issue[] = [
  { id: "BATCH-001", company: "FreshFarms GmbH", type: "Temperature Deviation", severity: "High", date: "2026-03-25" },
  { id: "BATCH-002", company: "AlpenMilch AG", type: "Contamination Risk", severity: "Critical", date: "2026-03-26" },
  { id: "BATCH-003", company: "GrainCo Ltd", type: "Packaging Defect", severity: "Low", date: "2026-03-27" },
];
...
const columns: IssueColumn<Issue>[] = [
  ...
  { header: "Batch ID", render: (r) => <span className="font-mono">{r.id}</span> },
];
...
export default function ProductionIssues() {
  ...
  return (
    <div className="space-y-8">
      ...
      />
      <IssueDetailSheet issue={selected} onClose={() => setSelected(null)} tag="Production" />
    </div>
  );
}
